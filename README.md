...
Create a `protk.dat` file in your CREO working directory as follows:
...
Or use one that is automatically generated by cmake in `${PROJECT_BINARY_DIR}` (e.g. `C:\Users\ngenesio\icub-tech-iit\creo2urdf\build\x64-Release`).
