...
| `meshQuality` | Integer |  3 | Quality of the meshes exported. The value is between 1 and 10, where 1 is the lowest quality and 10 is the highest quality. NOTE: this is valid for the stl meshes. |
