...
static const std::map<std::string, std::string> link_csys_map = {
    {"SIM_ECUB_L_HIP_1","SCSYS_L_HIP_1"},
    {"SIM_ECUB_L_HIP_2","SCSYS_L_HIP_2"},
    {"SIM_ECUB_L_HIP_3","SCSYS_L_HIP_3"},
    {"SIM_ECUB_L_UPPER_LEG","SCSYS_L_UPPER_LEG"},
    {"SIM_ECUB_L_LOWER_LEG","SCSYS_L_LOWER_LEG"},
    {"SIM_ECUB_L_ANKLE_1","SCSYS_L_ANKLE_1"},
    {"SIM_ECUB_L_ANKLE_2","SCSYS_L_ANKLE_2"},
    {"SIM_ECUB_L_FOOT_FRONT","SCSYS_L_FOOT_FRONT"},
    {"SIM_ECUB_L_FOOT_REAR","SCSYS_L_FOOT_REAR"},
    {"SIM_ECUB_R_HIP_1","SCSYS_R_HIP_1"},
    {"SIM_ECUB_R_HIP_2","SCSYS_R_HIP_2"},
    {"SIM_ECUB_R_HIP_3","SCSYS_R_HIP_3"},
    {"SIM_ECUB_R_UPPER_LEG","SCSYS_R_UPPER_LEG"},
    {"SIM_ECUB_R_LOWER_LEG","SCSYS_R_LOWER_LEG"},
    {"SIM_ECUB_R_ANKLE_1","SCSYS_R_ANKLE_1"},
    {"SIM_ECUB_R_ANKLE_2","SCSYS_R_ANKLE_2"},
    {"SIM_ECUB_R_FOOT_FRONT","SCSYS_R_FOOT_FRONT"},
    {"SIM_ECUB_R_FOOT_REAR","SCSYS_R_FOOT_REAR"},
    ...
    {"SIM_ECUB_L_FOREARM","SCSYS_L_FOREARM"},
    {"SIM_ECUB_L_WRIST_1","SCSYS_L_WRIST_1"},
    {"SIM_ECUB_L_WRIST_2","SCSYS_L_WRIST_ROLL"},
    {"SIM_ECUB_L_HAND_PALM","SCSYS_L_HAND_PALM"},
    {"SIM_ECUB_L_HAND_THUMB_1","SCSYS_L_HAND_THUMB_MCARP"},
    {"SIM_ECUB_L_HAND_THUMB_2","SCSYS_L_HAND_THUMB_MED"},
    {"SIM_ECUB_L_HAND_THUMB_3","SCSYS_L_HAND_THUMB_DIST"},
    {"SIM_ECUB_L_HAND_INDEX_1","SCSYS_L_HAND_INDEX_PROX"},
    {"SIM_ECUB_L_HAND_INDEX_2","SCSYS_L_HAND_INDEX_MED"},
    {"SIM_ECUB_L_HAND_INDEX_3","SCSYS_L_HAND_INDEX_DIST"},
    {"SIM_ECUB_L_HAND_MIDDLE_1","SCSYS_L_HAND_MIDDLE_MED"},
    {"SIM_ECUB_L_HAND_MIDDLE_2","SCSYS_L_HAND_MIDDLE_DIST"},
    {"SIM_ECUB_L_HAND_RING_1","SCSYS_L_HAND_RING_1"},
    {"SIM_ECUB_L_HAND_RING_2","SCSYS_L_HAND_RING_DIST"},
    {"SIM_ECUB_L_HAND_PINKIE_1","SCSYS_L_HAND_PINKIE_MED"},
    {"SIM_ECUB_L_HAND_PINKIE_2","SCSYS_L_HAND_PINKIE_DIST"},
    ...
    {"SIM_ECUB_R_FOREARM","SCSYS_R_FOREARM"},
    {"SIM_ECUB_R_WRIST_1","SCSYS_R_WRIST_YAW"},
    {"SIM_ECUB_R_WRIST_2","SCSYS_R_WRIST_ROLL"},
    {"SIM_ECUB_R_HAND_PALM","SCSYS_R_HAND_PALM"},
    {"SIM_ECUB_R_HAND_THUMB_1","SCSYS_R_HAND_THUMB_MCARP"},
    {"SIM_ECUB_R_HAND_THUMB_2","SCSYS_R_HAND_THUMB_MED"},
    {"SIM_ECUB_R_HAND_THUMB_3","SCSYS_R_HAND_THUMB_DIST"},
    {"SIM_ECUB_R_HAND_INDEX_1","SCSYS_R_HAND_INDEX_PROX"},
    {"SIM_ECUB_R_HAND_INDEX_2","SCSYS_R_HAND_INDEX_MED"},
    {"SIM_ECUB_R_HAND_INDEX_3","SCSYS_R_HAND_INDEX_DIST"},
    {"SIM_ECUB_R_HAND_MIDDLE_1","SCSYS_R_HAND_MIDDLE_MED"},
    {"SIM_ECUB_R_HAND_MIDDLE_2","SCSYS_R_HAND_MIDDLE_DIST"},
    {"SIM_ECUB_R_HAND_RING_1","SCSYS_R_HAND_RING_MED"},
    {"SIM_ECUB_R_HAND_RING_2","SCSYS_R_HAND_RING_DIST"},
    {"SIM_ECUB_R_HAND_PINKIE_1","SCSYS_R_HAND_PINKIE_MED"},
    {"SIM_ECUB_R_HAND_PINKIE_2","SCSYS_R_HAND_PINKIE_DIST"},
